...
const translations = {
  id: {
    ...
    aboutDesc: "Saya seorang Spesialis Full-Stack Developer. Saya tidak hanya menulis kode yang bersih dan terukur untuk backend, saya memastikan pengalaman pengguna sempurna dengan animasi dinamis yang halus dan tata letak responsif di frontend. Saya menciptakan solusi perangkat lunak yang lengkap dan optimal yang memberikan kinerja tinggi tanpa mengorbankan keunggulan visual.",
    ...
    cert1Title: "Pengembangan Web Front-End Expert",
    cert1Issuer: "Dicoding Academy",
    cert1Year: "2024",
    cert2Title: "React Developer Certification",
    cert2Issuer: "TechAcademy",
    cert2Year: "2024",
    cert3Title: "UI/UX Design Professional",
    cert3Issuer: "Global UX Institute",
    cert3Year: "2023",
    ...
    contactFormNamePl: "misal: Achmad Khoiri",
  ...
  en: {
    ...
    aboutSub: "About Me",
    aboutTitle: "FullStack Developer.",
    aboutDesc: "I am a Specialist Full-Stack Developer. I don't just write clean, scalable code for the backend, I ensure the user experience is flawless with smooth, dynamic animations and responsive layouts on the frontend. I create complete, optimized software solutions that deliver high performance without sacrificing visual excellence.",
    ...
    cert1Title: "Front-End Web Development Expert",
    cert1Issuer: "Dicoding Academy",
    cert1Year: "2024",
    cert2Title: "React Developer Certification",
    cert2Issuer: "TechAcademy",
    ...
    contactFormNamePl: "e.g., Achmad Khoiri",
